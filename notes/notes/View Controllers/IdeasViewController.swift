...
class IdeasViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        do {
            let fetchRequest = IdeaNote.createFetchRequest()
    ...
    private func setupUI() {
        self.title = "Ideas"
        self.view.backgroundColor = AppConstants.Color.paleBlue
    ...
    @objc private func addNote() {
        let newNote = IdeaNote.new(context: self.context)
        self.notes.append(newNote)
        self.edit(note: newNote)
    }
    
    private func edit(note: IdeaNote) {
